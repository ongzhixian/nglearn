...
@Component({
    selector: 'app-companion-data-entry',
    templateUrl: './companion-data-entry.component.html',
    styleUrls: ['./companion-data-entry.component.css']
})
export class CompanionDataEntryComponent implements OnInit {
