...
describe('DummyPage1Component', () => {
  ...
  describe("When a TravelLane option is selected ",function () {
   
    it('should set TravelLane to be selectedTravelLane', () => {
  ...
  }); // end describe("When a TravelLane option is selected
